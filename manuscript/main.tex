...
remains poorly constrained. To illustrate this, Fig. 1 shows zonal means of
...
the systematic underestimation of high latitude precipitation. The previoous
...
The GPROF-NN XPR retrieval algorith is a machine-learning based precipitation
retrieval that is trained to simultaneously provide estimates of CPR-based and
DPR-based precipitation. The two estimates are subsequently fused to provide a
general precipitation estimate that better represents precipitation across
different precipitation regimes. Below we describe the retrieval implementation
together with the data sources used to validate the retrieval itself as well as
the two radar-based reference datasets.
...
(2024). An updated version of GPROF-NN is currently under development, which
will become the operational precipitation retrieval of the GPM constellation as
GPROF V08. It is designed to provide estimates of light
precipitation missing from DPR-based retrievals and thus construct improved
training data for the next version of GPROF-NN retrievals.
